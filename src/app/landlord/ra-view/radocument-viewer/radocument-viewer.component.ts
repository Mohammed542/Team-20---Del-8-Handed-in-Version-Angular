...
export class RADocumentViewerComponent implements OnInit {
  RAID = sessionStorage['RentalAgreementID'];
  fileBase64;
  constructor(private router: Router, private service: MainService, private matSnackBar: MatSnackBar, private dialogRef: MatDialogRef<RADocumentViewerComponent>) { }
