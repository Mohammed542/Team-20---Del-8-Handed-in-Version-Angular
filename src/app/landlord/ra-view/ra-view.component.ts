...
@Component({
  selector: 'app-ra-view',
  templateUrl: './ra-view.component.html',
  styleUrls: ['./ra-view.component.scss']
})
export class RaViewComponent implements OnInit {
  ...
  onClickRA(){
    this.router.navigate(["landlord/viewRentalAgreement/viewRAdocs"]);
  }
  onClickTenantID(){
    this.router.navigate(["landlord/viewRentalAgreement/viewTenantIDdocs"]);
  }
  onClickCompanyID(){
    this.router.navigate(["landlord/viewRentalAgreement/viewCompanyIDdocs"]);
  }
  onClickCompanyCIPC(){
    this.router.navigate(["landlord/viewRentalAgreement/viewCompanyCIPCdocs"]);
  }
