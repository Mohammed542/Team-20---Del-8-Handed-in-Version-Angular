...
@Component({
  selector: 'app-report-electricity',
  templateUrl: './report-electricity.component.html',
  styleUrls: ['./report-electricity.component.scss']
})
export class ReportElectricityComponent implements OnInit {
  ...
  async onGenerateReport() {
    ...
    await this.service.getElectricityData(this.toSend).subscribe(res => {
      console.log(res);
      this.allData = res;
